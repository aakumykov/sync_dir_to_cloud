...
class LogOfSyncAdapter(private val lifecycleScope: CoroutineScope) : ListHoldingListAdapter<LogOfSync, LogOfSyncViewHolder>(R.layout.sync_log_view_holder) {
    override fun createViewHolder(): ViewHolder<LogOfSync> {
        return LogOfSyncViewHolder(lifecycleScope)
    }
}