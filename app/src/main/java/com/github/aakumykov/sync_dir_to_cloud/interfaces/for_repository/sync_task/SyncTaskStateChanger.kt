...
interface SyncTaskStateChanger {
    ...
    suspend fun changeSchedulingState(taskId: String, newState: SyncState, errorMsg: String = "")

    suspend fun changeExecutionState(taskId: String, newState: SyncState, errorMsg: String = "")
