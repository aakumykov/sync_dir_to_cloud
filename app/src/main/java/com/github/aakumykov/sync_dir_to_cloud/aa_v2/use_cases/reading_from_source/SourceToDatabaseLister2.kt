...
interface SourceToDatabaseLister2AssistedFactory {
    fun create(
        syncObjectReader: SyncObjectReader,
        syncObjectAdder: SyncObjectAdder,
        syncObjectUpdater: SyncObjectUpdater,
    ): SourceToDatabaseLister2
}

class SourceToDatabaseLister2 @AssistedInject constructor(
    private val recursiveDirReaderFactory: RecursiveDirReaderFactory,
    @Assisted private val syncObjectReader: SyncObjectReader,
    @Assisted private val syncObjectAdder: SyncObjectAdder,
    @Assisted private val syncObjectUpdater: SyncObjectUpdater,
    @Assisted private val syncTaskStateChanger: SyncTaskStateChanger,
    ...
    private suspend fun logExecutionFinished(taskId: String, executionId: String) {
        executionLogger.updateLog(
            ExecutionLogItem.createFinishingItem(
            taskId = taskId,
            executionId = executionId,
            message = getString(R.string.EXECUTION_LOG_reading_source)
        ))
