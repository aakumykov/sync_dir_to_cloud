...
class AppSettingsImpl @Inject constructor(
    ...
    override var restoreLostSourceAndTargetDirs: Boolean
        get() = sharedPreferences.getBoolean(getString(R.string.KEY_re_create_missing_source_and_target_dirs), getBoolean(R.bool.DEFAULT_re_create_missing_source_and_target_dirs))
        set(value) { sharedPreferences.edit().putBoolean(getString(R.string.KEY_re_create_missing_source_and_target_dirs), value).apply() }
}