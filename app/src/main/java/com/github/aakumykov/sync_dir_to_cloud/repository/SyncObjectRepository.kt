        ...
        SyncTaskDirObjectReader
{
    ...
    override suspend fun deleteObjectsWithDeletedState(taskId: String) {
        syncObjectDAO.deleteObjectsWithDeletedState(taskId)
    }
    ...
    override suspend fun updateName(objectId: String, newName: String) {
