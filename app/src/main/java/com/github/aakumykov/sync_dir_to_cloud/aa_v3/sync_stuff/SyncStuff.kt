...
class SyncStuff @Inject constructor(
    ...
    suspend fun prepareFor(syncTask: SyncTask, executionId: String): SyncStuff {
        ...
        _cloudReader = cloudReadersHolder.getCloudReader(syncTask.sourceStorageType, sourceAuth?.authToken!!)
        _cloudWriter = cloudWritersHolder.getCloudWriter(syncTask.targetStorageType, targetAuth?.authToken!!)
