...
class LogOfSyncAdapter(private val syncLogViewHolderClickCallbacks: SyncLogViewHolderClickCallbacks) :
    ...
    override fun createViewHolder(): ViewHolder<LogOfSync> {
        return LogOfSyncViewHolder(syncLogViewHolderClickCallbacks)
    }
}