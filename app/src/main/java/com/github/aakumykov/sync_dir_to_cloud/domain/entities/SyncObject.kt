...
/**
 * [SyncObject] - минимальная единица хранения, самый низкоуровневый объект в
 * иерархии объектов бизнес-логики. Представляет объект в хранилище: файл или каталог.
 * Имеет свойства, присущие этим объектам:
 * - имя
 * - размер
 * - время создания/изменения(/доступа/и т.д.)
 *
 ...
 * С другой - где его ещё хранить? Следующий "уровень" - это [ComparisonState],
...
class SyncObject (
    ...
    companion object {
        ...
        fun createFromExisting(syncObject: SyncObject,
                               ...
                               newStateInStorage: StateInStorage
        ): SyncObject {
            return syncObject.apply {
                id = newRandomId
                executionId = newExecutionId
